...
# META-NFT-Market
# 项目介绍 --  鲸探 幻核 幻藏 iBox 唯一艺术 套娃 大蛇文创 蚂蚁数藏 18数藏
...
支持平台邀新注册活动、直购、优先购、盲盒、空投、兑换、卡券、预约、抽（中）签、转赠、合成玩法、二级（衍生品）流通交易、直推返佣、用户铸造、发行等功能
...
100%原创全新开发，专为NFT数藏设计而生的架构，而非其他系统改造的那种漏洞百出的转手N次的模板系统。
...
[元宇宙Meta NFT藏品 服务端系统源码 Meta-Server](https://github.com/Meta-NFT-boy/meta-nft-server)
...
自行发行藏品，官方审核，发布，交易分成，二级之后，创作者可以获得二级市场的持续版权费收入！

# 群组聊天（IM功能）

网络通信采用 socket 实现

自带即时通讯聊天群，群分公开或私密。私密的必须持有特定藏品才可以加入，系统会根据持有藏品情况自动加入或者移出群!

# 返佣 

根据用户直推返佣金，实现不同期间不同档次的藏品在不同持有期间的返利都会不一样，同期间不同勋章按最高的比例计算。

同时支持持仓多个藏品返佣，如：藏品A返佣30%，藏品B返佣15%，藏品C。。。。
...
中签可以系统开奖后直接推送购买白名单或获得免费空投藏品，再或者可获得中签盲盒，用户自行开启，增加趣味性
...
完整后台功能，更多运营利器等您发现，不一一罗列

# 上链铸造NFT
目前系统同时支持公链和联盟链，可以同时存在。
